...
//internal class JVMGenericArrayTypeToken<T>(private val trueType: GenericArrayType) : JVMTypeToken<T>() {
//    private var wrappedType: Type? = null
//
...
//        val type = wrappedType as? ParameterizedType
...
//    }
//
//    override val jvmType: Type = wrappedType ?: run {
